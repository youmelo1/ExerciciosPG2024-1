...
//#endif
	...
	glm::mat4 model1 = glm::translate(glm::mat4(1.0f), glm::vec3(200.0f, 200.0f, 0.0f));
	glm::mat4 model2 = glm::translate(glm::mat4(1.0f), glm::vec3(400.0f, 200.0f, 0.0f));
	glm::mat4 model3 = glm::translate(glm::mat4(1.0f), glm::vec3(600.0f, 200.0f, 0.0f));
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// Primeira geometria
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(150.0f, 300.0f, 0.0f));
		model = glm::rotate(model, angle*1, glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::scale(model, glm::vec3(600.0f, 300.0f, 0.0f));
		shader.setMat4("model", glm::value_ptr(model));
		drawScene(VAO, texID);
		...
		model = glm::rotate(model, angle*5, glm::vec3(0.0f, 0.0f, 1.0f));
		...
		// Terceira geometria
		model = glm::mat4(1.0f); 
		model = glm::translate(model, glm::vec3(650.0f, 300.0f, 0.0f));
		model = glm::rotate(model, angle*15, glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::scale(model, glm::vec3(100.0f, 300.0f, 0.0f));
		shader.setMat4("model", glm::value_ptr(model));
		drawScene(VAO, texID);
