...
//#endif
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Triângulo RGB", nullptr, nullptr);
...
int exercicio8()
{
	...
	GLfloat vertices[] = {
		//x   y     z    r   g    b
		  0.0, 0.5, 0.0, 1.0, 0.0, 0.0,//P1
		 -0.5,-0.5, 0.0, 0.0, 1.0, 0.0,//P2
		  0.5,-0.5, 0.0, 0.0, 0.0, 1.0,//P3 
	};
